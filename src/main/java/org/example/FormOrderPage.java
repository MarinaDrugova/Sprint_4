...
public class FormOrderPage {
    ...
    public void enterFieldSurnameInput(String text) {//ввести фамилию заказчика
        driver.findElement(fieldSurnameInput).sendKeys(text);
    }

    public void enterFieldAddressInput(String text) {//ввести адрес заказчика
        driver.findElement(fieldAddressInput).sendKeys(text);
    }
